...
public class StringAndStringBuilder {
	public static void main(String[] args) {
		...
		// c below is an object... the word NEW has allocated memory for it in the
		// memory
		...
		// find the last character in the string...minus one because string starts at 0
		// so -1 gets the last char
		System.out.println("Last char = " + c.charAt(c.length() - 1));

		// String object c to UPPERCASE. objects are immutable so assign it to a new
		// variable
		c = c.toUpperCase();
